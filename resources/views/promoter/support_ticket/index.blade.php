          ...
          <div class="row">
            ...
            <div class="col-lg-8 mt-2 mt-lg-0">
              <button class="btn btn-danger float-lg-right float-none btn-sm ml-2 mt-1 bulk-delete d-none"
                data-href="{{ route('scanner.support_tickets.bulk_delete') }}"><i class="flaticon-interface-5"></i>
                {{ __('Delete') }}</button>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a href="{{ route('scanner.support_tickets.message', $item->id) }}"
                                  class="dropdown-item">
                                  {{ __('Message') }}
                                </a>
                                <form class="deleteForm d-block"
                                  action="{{ route('scanner.support_tickets.delete', $item->id) }}" method="post">
                                  @csrf
