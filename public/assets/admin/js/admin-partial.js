...
$(document).ready(function () {
  ...
  // event price type
  $(`input:radio[name="pricing_type_2"], input:radio[name="ticket[pricing_type_2]"]`).on('change', function () {
    let radioBtnVal = $(`input:radio[name="pricing_type_2"]:checked, input:radio[name="ticket[pricing_type_2]"]:checked`).val();
  ...
  $('thead').on('click', '.addRow', function () {
    ...
    var tr = `<tr><tr>
        ...
        <td rowspan="2"><a href="javascript:void(0)" class="btn btn-danger btn-sm deleteRow" > <i class="fas fa-minus"></i></a></td>
      </tr>
      <tr>
        <td colspan="3" >
      ...
      <tr>
       <td colspan="4">
    <div style="display: flex; flex-direction: column; align-items: center;">
        <label for="">Período das vendas</label>
        <div style="display: flex; gap: 10px;"> <!-- Usando flexbox para os botões -->
            <label class="selectgroup-item">
                <input type="radio" name="status_${id}" value="1" class="selectgroup-input" checked>
                <span class="selectgroup-button">Por data</span>
            </label>
            <label class="selectgroup-item">
                <input type="radio" name="status_${id}" value="2" class="selectgroup-input">
                <span class="selectgroup-button">Por lote</span>
            </label>
        </div>
    </div>
</td>
