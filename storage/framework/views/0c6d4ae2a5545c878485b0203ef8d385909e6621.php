        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="settingsForm" action="<?php echo e(route('admin.user_management.push_notification.update_settings')); ?>"
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <?php if(!is_null($data->notification_image)): ?>
                      <img src="<?php echo e(asset('assets/admin/img/' . $data->notification_image)); ?>" alt="image"
                        class="uploaded-img">
                    <?php else: ?>
                    ...
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vapid_public_key" value=""
                          placeholder="<?php echo e(__('Enter VAPID Public Key')); ?>">
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vapid_private_key" value=""
                          placeholder="<?php echo e(__('Enter VAPID Private Key')); ?>">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/end-user/push-notification/settings.blade.php ENDPATH**/ ?>