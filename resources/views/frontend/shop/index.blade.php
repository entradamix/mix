  ...
  <section class="page-banner overlay pt-120 pb-125 rpt-90 rpb-95 lazy"
    ...
    <div class="container">
      <div id="event-search" class="hero-content event-search py-35">
        ...
        {{-- <div class="widget products-dropdown search-item">
              ...
              @if (count($products) > 0)
                @foreach ($products as $item)
                  <div class="col-md-4 col-sm-6">
                    <div class="shop-item">
                        <div class="image">
                            <img class="lazy" data-src="{{ asset('assets/admin/img/product/feature_image/' . $item->feature_image) }}" alt="Product">
                            <div class="product-icons">
                                {{--
                                    <a class="cart-link cart" data-href="{{ route('add.cart', $item->id) }}" data-toggle="tooltip" data-placement="top" title="{{ __('Add to Cart') }}">
                                        <i class="fas fa-shopping-cart"></i>
                                    </a>
                                --}}
                                <a href="{{ route('shop.details', ['slug' => $item->slug, 'id' => $item->id]) }}" class="view"><i class="far fa-eye"></i></a>
                            </div>
                      </div>
                      @php
