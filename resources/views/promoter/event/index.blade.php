    ...
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            @if (request()->filled('event_type') && request()->input('event_type') == 'venue')
                ...
                <li class="nav-item">
                    <a
                        href="{{ route('promoter.event_management.event', ['language' => $defaultLang->code, 'event_type' => 'venue']) }}">{{ __('Venue Events') }}</a>
                </li>
            @endif
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="{{ route('promoter.add.event.event', ['type' => 'online']) }}"
                                        class="dropdown-item">
                                        {{ __('Online Event') }}
                                    </a>

                                    <a href="{{ route('promoter.add.event.event', ['type' => 'venue']) }}"
                                        class="dropdown-item">
                                        {{ __('Venue Event') }}
                                    </a>
                                </div>
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                data-href="{{ route('promoter.event_management.bulk_delete_event') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($event->event_type == 'venue')
                                                            <a href="{{ route('promoter.event.ticket', ['language' => request()->input('language'), 'event_id' => $event->id, 'event_type' => $event->event_type]) }}"
                                                                class="btn btn-success btn-sm">{{ __('Manage') }}</a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <form id="statusForm-{{ $event->id }}" class="d-inline-block"
                                                            action="{{ route('promoter.event_management.event.event_status', ['id' => $event->id, 'language' => request()->input('language')]) }}"
                                                            method="post">
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="featuredForm-{{ $event->id }}"
                                                            ...
                                                            action="{{ route('promoter.event_management.event.update_featured', ['id' => $event->id]) }}"
                                                            method="post">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a href="{{ route('promoter.event_management.edit_event', ['id' => $event->id]) }}"
                                                                    class="dropdown-item">
                                                                    {{ __('Edit') }}
                                                                </a>

                                                                <form class="deleteForm d-block"
                                                                    action="{{ route('promoter.event_management.delete_event', ['id' => $event->id]) }}"
                                                                    method="post">
