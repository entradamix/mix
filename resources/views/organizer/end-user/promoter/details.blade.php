...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Promoter Details') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('organizer.promoter_management.registered_promoter') }}">{{ __('Registered Promoter') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{ __('Promoter Details') }}</a>
      </li>
    </ul>
  </div>
                  ...
                  <div class="author">
                    ...
                    @else
                      <img class="uploaded-img rounded-circle mh70"
                        src="{{ asset('assets/admin/img/promoter-photo/' . $promoter->photo) }}" alt="image">
                    @endif
                    <div class="h6 card-title">{{ __('Promoter Information') }}</div>
                  </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="card-body">
              <div class="payment-information">
                <div class="row mb-2">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->name }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->designation }}
                  </div>
                </div>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->country }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->city }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->state }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->zip_code }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->address }}
                  </div>
                </div>
                <div class="row mb-2">
                  <div class="col-lg-4">
                  ...
                  <div class="col-lg-8">
                    {{ optional($promoter->promoter_info)->details }}
                  </div>
                </div>
              </div>
            </div>
