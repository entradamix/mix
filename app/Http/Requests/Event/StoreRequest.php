...
class StoreRequest extends FormRequest
{
  ...
  public function rules()
  {
    ...
    //   if ($request['ticket']['early_bird_discount_type'] == 'enable' && $request['ticket']['discount_type'] == 'percentage') {
    //     $ruleArray['*.early_bird_discount_amount'] = 'numeric|between:1,99';
    //   } elseif ($request['ticket']['early_bird_discount_type'] == 'enable' && $request['ticket']['discount_type'] == 'fixed') {
    //     $price = $request['ticket']['price'] - 1;
    //     $ruleArray['*.early_bird_discount_amount'] = "numeric|between:1, $price";
    //   }
    // }
    ...
    //   if ($request['*.early_bird_discount_type'] == 'enable' && $request['ticket']['discount_type'] == 'percentage') {
    //     $ruleArray['*.early_bird_discount_amount'] = 'numeric|between:1,99';
    //   } elseif ($request['*.early_bird_discount_type'] == 'enable' && $request['ticket']['discount_type'] == 'fixed') {
