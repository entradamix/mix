...
<?php
  ...
  $events_caroussel = DB::table('event_contents')
      ...
      ->get();
      // Remove o carrossel dos eventos, mantido código para possível aproveitamento futuro.
      $events_caroussel = [];
?>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/event/event.blade.php ENDPATH**/ ?>