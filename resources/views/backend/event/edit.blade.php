                            ...
                            <div class="row">
                              <div class="col-lg-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" placeholder="Enter Zip/Post Code"
                                    name="{{ $language->code }}_zip_code" id="zip_code"
                              ...
                              <div class="col-lg-8">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="{{ $language->code }}_address" id="address"
                                    class="form-control {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="{{ $language->code }}_country" id="country"
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="{{ $language->code }}_state" id="state"
                                    class="form-control {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                              ...
                              <div class="col-lg-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="{{ $language->code }}_city" id="city"
                                    class="form-control {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
