    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-4">
        <div class="button-group">
            <a href="#" id="clipboard">
                <input type="hidden" id="foo" value="{{ url()->current() }}">
            ...
            <a href="//twitter.com/intent/tweet?text=my share text&amp;url={{ urlencode(url()->current()) }}" target="_blank">
                <i class="fab fa-twitter"></i>
                <p>{{ __('Twitter') }}</p>
            </a>
            <a href="//www.linkedin.com/shareArticle?mini=true&amp;url={{ urlencode(url()->current()) }}&amp;title=" target="_blank">
