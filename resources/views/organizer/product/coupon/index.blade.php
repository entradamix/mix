        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete" data-href="{{ route('organizer.shop_management.bulk_delete_coupon') }}">
                      ...
                      @foreach ($collection as $item)
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block" action="{{ route('organizer.shop_management.delete_coupon', ['id' => $item->id]) }}" method="post">
