                                              ...
                                              <div class="row ">
                                                ...
                                                <div class="col-lg-12">
                                                  <div class="form-group mt-1">
                                                    ...
                                                    <div class="selectgroup w-100">
                                                      <label class="selectgroup-item">
                                                        <input type="radio" name="ticket[pricing_type_2]" value="free" class="selectgroup-input" checked>
                                                        <span class="selectgroup-button"><?php echo e(__('Free Tickets')); ?></span>
                                                      </label>
                            
                                                      <label class="selectgroup-item">
                                                        <input type="radio" name="ticket[pricing_type_2]" value="variation" class="selectgroup-input">
                                                        <span class="selectgroup-button"><?php echo e(__('Variation Wise')); ?></span>
                                                      </label>
                            
                                                      <label class="selectgroup-item">
                                                        <input type="radio" name="ticket[pricing_type_2]" value="normal" class="selectgroup-input">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                              <div class="from-group mt-1">
                                                                <input type="checkbox" checked name="ticket[v_ticket_available_type][]" value="limited"
...
<?php echo $__env->make('organizer.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/organizer/event/create.blade.php ENDPATH**/ ?>