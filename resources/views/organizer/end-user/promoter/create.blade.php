...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ __('Add Promoter') }}</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-title">{{ __('Add Promoter') }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            ...
                            <form id="eventForm" action="{{ route('organizer.promoter_management.save-promoter') }}"
                                method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
