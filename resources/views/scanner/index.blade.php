...
@section('content')
  <div class="mt-2 mb-4">
    <h2 class=" pb-2 ">{{ __('Welcome back') .','}} {{ Auth::guard('scanner')->user()->username . '!' }}</h2>
  </div>

  @if (Session::get('secret_login') != true)
    @if (Auth::guard('scanner')->user()->status == 0 && $admin_setting->organizer_admin_approval == 1)
      <div class="mt-2 mb-4">
  ...
  <div class="row dashboard-items">
    <div class="col-xl-3 col-lg-6">
      <a href="{{ route('scanner.monthly_income') }}">
              ...
              <div class="col-7 col-stats">
                <div class="numbers">
                  ...
                  <h4 class="card-title">
                    ...
                    {{ round(Auth::guard('scanner')->user()->amount, 2) }}
