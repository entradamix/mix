        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 mx-auto">
              <form id="scannerSettingForm" action="{{ route('organizer.scanner_management.setting.update') }}"
                method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="custom-control custom-checkbox">
                        <input type="checkbox" {{ $setting->scanner_email_verification == 1 ? 'checked' : '' }}
                          name="scanner_email_verification" class="custom-control-input" id="customCheck2">
                  ...
                  <div
                    ...
                    <div class="form-group">
                      ...
                      <p class="text-warning">{{ __('This text will be visible in scanner Dashboard') }}</p>
                    </div>
                  </div>
