...
class ProductController extends Controller
{
  ...
  {
    $digital_product = Product::where('type', 'digital');
    $physical_product = Product::where('type', 'physical');
    
    if(Auth::guard('organizer')->user()){
        $digital_product->where('organizer_id', Auth::guard('organizer')->user()->id);
        $physical_product->where('organizer_id', Auth::guard('organizer')->user()->id);
    }

    $information['digital_product'] = $digital_product->get()->count();;
    $information['physical_product'] = $physical_product->get()->count();;
    
    if(Auth::guard('organizer')->user()){
        return view('organizer.product.index', $information);
    }else{
  ...
  public function create(Request $request)
  {
    ...
    if(Auth::guard('organizer')->user()){
        return view('organizer.product.create', $information);
    }else{
  ...
  public function show(Request $request)
  {
    ...
    if(Auth::guard('organizer')->user()){
        return view('organizer.product.show', $information);
    }else{
  ...
  public function edit(Request $request)
  {
    ...
    if(Auth::guard('organizer')->user()){
        return view('organizer.product.edit', $information);
    }else{
