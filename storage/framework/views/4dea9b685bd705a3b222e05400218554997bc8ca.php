  ...
  <?php $__currentLoopData = $popupInfos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popupInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($type == 1): ?>
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div>
          <img data-src="<?php echo e(asset('assets/admin/img/popups/' . $popupInfo->image)); ?>" class="lazy" alt="Popup Image" width="100%">
        </div>
      </div>
    <?php elseif($type == 2): ?>
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div class="popup-one bg_cover lazy" data-bg="<?php echo e(asset('assets/admin/img/popups/' . $popupInfo->image)); ?>">
    ...
    <?php elseif($type == 3): ?>
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div class="popup-two bg_cover lazy" data-bg="<?php echo e(asset('assets/admin/img/popups/' . $popupInfo->image)); ?>">
          <div class="popup_main-content" style="background-color: <?php echo e('#' . $popupInfo->background_color); ?>; opacity: <?php echo e($popupInfo->background_color_opacity); ?>;">
            <h1><?php echo e($popupInfo->title); ?></h1>
            <p><?php echo e($popupInfo->text); ?></p>
      ...
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div class="popup-three">
          <div class="popup_main-content">
            <div class="left-bg bg_cover lazy" data-bg="<?php echo e(asset('assets/admin/img/popups/' . $popupInfo->image)); ?>"></div>
    ...
    <?php elseif($type == 6): ?>
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div class="popup-five bg_cover lazy" data-bg="<?php echo e(asset('assets/admin/img/popups/' . $popupInfo->image)); ?>">
          <div class="popup_main-content">
            <h1><?php echo e($popupInfo->title); ?></h1>
      ...
      <div data-popup_delay="<?php echo e($popupInfo->delay); ?>" data-popup_id="<?php echo e($popupInfo->id); ?>" id="modal-popup-<?php echo e($popupInfo->id); ?>" class="popup-wrapper">
        <div class="popup-six">
          <div class="popup_main-content">
            ...
            <div class="right-content bg_cover" style="background-color: <?php echo e('#' . $popupInfo->background_color); ?>; background-image: url(<?php echo e(asset('assets/admin/img/popups/right-bg.png')); ?>);">
              <h1><?php echo e($popupInfo->title); ?></h1>
              <h4><?php echo e($popupInfo->text); ?></h4>
...
<?php endif; ?>
<?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/frontend/partials/popups.blade.php ENDPATH**/ ?>