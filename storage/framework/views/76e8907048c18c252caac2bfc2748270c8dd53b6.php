<?php $__env->startSection('pageHeading'); ?>
  <?php if(!empty($pageHeading)): ?>
    <?php echo e($pageHeading->organizer_signup_page_title ?? __('Signup')); ?>
  ...
  <div class="signup-area pt-115 rpt-95 pb-120 rpb-100">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <form id="login-form" name="login_form" class="login-form" action="<?php echo e(route('organizer.create')); ?>"
            method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-sm-6">
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label for="lname"><?php echo e(__('Username')); ?> *</label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-0">
              <button class="theme-btn br-30" type="submit"
                data-loading-text="Please wait..."><?php echo e(__('Signup')); ?></button>
            </div>
            <div class="form-group mt-3 mb-0">
              <p><?php echo e(__('Already have an account')); ?>? <a class="text-info"
                  href="<?php echo e(route('organizer.login')); ?>"><?php echo e(__('Login Now')); ?></a></p>
            </div>
          </form>
        </div>
      </div>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/frontend/organizer/signup.blade.php ENDPATH**/ ?>