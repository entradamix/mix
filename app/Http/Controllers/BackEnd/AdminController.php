...
class AdminController extends Controller
{
  ...
  public function authentication(Request $request)
  {
    ...
    if (
      ...
      if ($authAdmin->status == 0) {
        Session::flash('alert', 'Desculpe, sua conta foi desativada!');
      ...
      return redirect()->back()->with('alert', 'Usuário ou senha inválida');
    }
  }
  ...
  public function sendMail(Request $request)
  {
    ...
    try {
      ...
      $mail->Body = 'Oi ' . $admin->first_name . ',<br/><br/>Sua senha foi resetada. Sua nova senha é: ' . $newPassword . '<br/><br/>Agora você pode logar com sua nova senha. Você pode reseta-la mais tarde.<br/><br/>Thank you.';

      $mail->send();

      Session::flash('success', 'O email foi enviado para o seu endereço.');
    } catch (Exception $e) {
      Session::flash('warning', 'Email não pode ser enviado. Ocorreu um erro: ' . $mail->ErrorInfo);
    }
  ...
  public function updatePassword(Request $request)
  {
    ...
    $messages = [
      'new_password.confirmed' => 'Confirmação da senha não confere.',
