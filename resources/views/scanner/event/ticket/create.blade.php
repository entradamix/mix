...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('scanner.event.ticket', ['language' => $defaultLang->code, 'event_id' => $event->event_id, 'event_type' => $eventType->event_type]) }}">{{ __('Tickets') }}</a>
      </li>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('scanner.event.ticket', ['language' => $defaultLang->code, 'event_id' => $event->event_id, 'event_type' => $eventType->event_type]) }}"
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="eventForm" action="{{ route('scanner.ticket_management.store_ticket') }}" method="POST"
