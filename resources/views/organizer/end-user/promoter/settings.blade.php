        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 mx-auto">
              <form id="promoterSettingForm" action="{{ route('organizer.promoter_management.setting.update') }}"
                method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                  ...
                  <div
                    ...
                    <div class="form-group">
                      ...
                      <p class="text-warning">{{ __('This text will be visible in promoter Dashboard') }}</p>
                    </div>
                  </div>
