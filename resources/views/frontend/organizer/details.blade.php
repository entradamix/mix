...
@section('hero-section')
  <!-- Page Banner Start -->
  <section class="page-banner overlay pt-120 pb-125 rpt-90 rpb-95 lazy" data-bg="{{ $organizer->cover != null ? asset('assets/admin/img/organizer-cover/' . $organizer->cover) : asset('assets/admin/img/' . $basicInfo->breadcrumb) }}">
    <div class="container">
