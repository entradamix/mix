...
@includeIf('organizer.partials.rtl-style')
...
@section('content')
        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete" data-href="{{ route('organizer.shop_management.bulk_delete_category') }}">
                      ...
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            ...
                            <form id="featuredForm-{{ $category->id }}" class="d-inline-block" action="{{ route('organizer.shop_management.update_category_feature', ['id'=>$category->id]) }}" method="post">
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block" action="{{ route('organizer.shop_management.delete_category', ['id' => $category->id]) }}" method="post">
  ...
  {{-- create modal --}}
  @include('organizer.product.category.create')

  {{-- edit modal --}}
  @include('organizer.product.category.edit')
@endsection
