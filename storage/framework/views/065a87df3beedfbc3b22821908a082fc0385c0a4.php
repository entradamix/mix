      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.basic_settings.store_social_media')); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="url" class="form-control" name="url" placeholder="<?php echo e(__('Enter URL of Social Media Account')); ?>">
            <p id="err_url" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for=""><?php echo e(__('Social Media Serial Number') . '*'); ?></label>
            <input type="number" class="form-control" name="serial_number" placeholder="<?php echo e(__('Enter Serial Number')); ?>">
...
<?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/basic-settings/social-media/create.blade.php ENDPATH**/ ?>