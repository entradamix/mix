  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Add Event Category')); ?></h5>
      ...
      <div class="modal-body">
        <form id="modalForm" class="modal-form create" action="<?php echo e(route('admin.event_management.store_category')); ?>"
          ...
          <div class="form-group">
            ...
            <select name="is_featured" class="form-control">
              <option selected disabled><?php echo e(__('Select featured status')); ?></option>
...
<?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/event/category/create.blade.php ENDPATH**/ ?>