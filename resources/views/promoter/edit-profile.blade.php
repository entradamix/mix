        ...
        <div class="card-body">
          <div class="row ">
            <div class="col-lg-8 mx-auto">
              ...
              <form id="eventForm" action="{{ route('promoter.update_profile') }}" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <div class="thumb-preview">
                        @if (Auth::guard('promoter')->user()->photo != null)
                          <img
                            src="{{ asset('assets/admin/img/promoter-photo/' . Auth::guard('promoter')->user()->photo) }}"
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <br>
                      <div class="thumb-preview">
                        @if (Auth::guard('promoter')->user()->cover != null)
                          <img
                            src="{{ asset('assets/admin/img/promoter-cover/' . Auth::guard('promoter')->user()->cover) }}"
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email"
                        value="{{ Auth::guard('promoter')->user()->email }}">
                      @if ($errors->has('email'))
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="tel" class="form-control" name="phone"
                        value="{{ Auth::guard('promoter')->user()->phone }}">
                      @if ($errors->has('phone'))
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="username"
                        value="{{ Auth::guard('promoter')->user()->username }}">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="facebook"
                        value="{{ Auth::guard('promoter')->user()->facebook }}">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="twitter"
                        value="{{ Auth::guard('promoter')->user()->twitter }}">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="linkedin"
                        value="{{ Auth::guard('promoter')->user()->linkedin }}">
                    ...
                    <div id="accordion" class="mt-3">
                      @foreach ($languages as $language)
                        <div class="version">
                          ...
                          @php
                            $promoter_info = App\Models\PromoterInfo::where('promoter_id', Auth::guard('promoter')->user()->id)
