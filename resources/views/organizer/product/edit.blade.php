...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('organizer.shop_management.products', ['language' => $defaultLang->code]) }}">{{ __('Products') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <div class="col-lg-12">
                ...
                <form action="{{ route('organizer.shop_management.product.imgstore') }}" id="my-dropzone"
              ...
              <form id="eventForm" action="{{ route('organizer.shop_management.product.update') }}" method="POST"
...
@section('variables')
  <script>
    "use strict";
    var storeUrl = "{{ route('organizer.shop_management.product.imgstore') }}";
    var removeUrl = "{{ route('organizer.shop_management.product.imgrmv') }}";

    var rmvdbUrl = "{{ route('organizer.shop_management.imgdbrmv') }}";
    var ProductloadImgs = "{{ route('organizer.shop_management.product.images', $product->id) }}";
  </script>
@endsection
