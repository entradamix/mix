...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('organizer.promoter_management.registered_promoter') }}">{{ __('Registered Promoters') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm"
                action="{{ route('organizer.promoter_management.promoter.update_password', ['id' => $userInfo->id]) }}"
                method="post">
                @csrf
