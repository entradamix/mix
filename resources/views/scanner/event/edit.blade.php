...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a
          href="{{ route('scanner.event_management.event', ['language' => $defaultLang->code]) }}">{{ __('All Events') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
        ...
        <div class="card-header">
          ...
          @if ($event->event_type == 'venue')
            <a class="mr-2 btn btn-secondary btn-sm float-right d-inline-block"
              href="{{ route('scanner.event.ticket', ['language' => $defaultLang->code, 'event_id' => $event->id, 'event_type' => $event->event_type]) }}"
              target="_blank">
              <span class="btn-label">
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <div class="col-lg-12">
                ...
                <form action="{{ route('scanner.event.imagesstore') }}" id="my-dropzone" enctype="multipart/formdata"
              ...
              <form id="eventForm" action="{{ route('scanner.event.update') }}" method="POST"
                                    ...
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                                              <a href="{{ route('scanner.event.add.ticket', ['language' => $defaultLang->code, 'event_id' => request()->input('event_id'), 'event_type' => request()->input('event_type')]) }}"
                                                      ...
                                                      <td>
                                                        <div class="dropdown">
                                                          ...
                                                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a href="{{ route('scanner.event.edit.ticket', ['language' => $defaultLang->code, 'event_id' => $event->id, 'event_type' => $ticket->event_type, 'id' => $ticket->id]) }}"
                                                              class="dropdown-item">
                                                              {{ __('Edit') }}
                                                            </a>
    
                                                            <form class="deleteForm d-block"
                                                              action="{{ route('scanner.ticket_management.delete_ticket', ['id' => $ticket->id]) }}"
                                                              method="post">
...
@section('variables')
  <script>
    "use strict";
    var storeUrl = "{{ route('scanner.event.imagesstore') }}";
    var removeUrl = "{{ route('scanner.event.imagermv') }}";

    var rmvdbUrl = "{{ route('scanner.event.imgdbrmv') }}";
    var loadImgs = "{{ route('scanner.event.images', $event->id) }}";
  </script>
@endsection
