                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 offset-lg-2">
                            <button class="btn btn-danger btn-sm float-right d-none bulk-delete ml-3 mt-1"
                                data-href="<?php echo e(route('admin.user_management.bulk_delete_subscriber')); ?>">
                            ...
                            <form class="float-right" action="<?php echo e(route('admin.user_management.subscribers')); ?>"
                                method="GET">
                                <input name="email" type="text" class="form-control min-230"
                                    placeholder="<?php echo e(__('Search By Email ID')); ?>"
                                    value="<?php echo e(!empty(request()->input('email')) ? request()->input('email') : ''); ?>">
                            </form>
                        </div>
                    </div>
                </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" class="bulk-check"
                                                            data-val="<?php echo e($subscriber->id); ?>">
                                                    </td>
                                                    <td><?php echo e($subscriber->email_id); ?></td>
                                                    <td>
                                                        <form class="deleteForm d-inline-block"
                                                            action="<?php echo e(route('admin.user_management.subscriber.delete', ['id' => $subscriber->id])); ?>"
                                                            method="post">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/end-user/subscriber/index.blade.php ENDPATH**/ ?>