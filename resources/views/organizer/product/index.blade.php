...
@section('content')
    ...
    <div class="product-type">
        ...
        <div class="row">
            <div class="col-lg-6">
                <a href="{{ route('organizer.shop_management.product.create', ['language' => $defaultLang->code, 'type=digital']) }}"
            ...
            <div class="col-lg-6">
                <a href="{{ route('organizer.shop_management.product.create', ['language' => $defaultLang->code, 'type=physical']) }}"
                    class="d-block text-decoration-none">
                    <div class="card card-stats card-round p-50">
                        <div class="card-body ">
                            <div class="row align-items-center">
