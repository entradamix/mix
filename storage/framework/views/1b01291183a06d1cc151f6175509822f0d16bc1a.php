        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="<?php echo e(route('admin.custom_pages.create_page')); ?>" class="btn btn-primary btn-sm float-right"><i
                  class="fas fa-plus"></i> <?php echo e(__('Add Page')); ?></a>

              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="<?php echo e(route('admin.custom_pages.bulk_delete_page')); ?>">
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="<?php echo e(route('admin.custom_pages.edit_page', ['id' => $page->page_id])); ?>"
                                  class="dropdown-item">
                                  <?php echo e(__('Edit')); ?>
                                ...
                                <form class="deleteForm d-block"
                                  action="<?php echo e(route('admin.custom_pages.delete_page', ['id' => $page->page_id])); ?>"
                                  method="post">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/custom-page/index.blade.php ENDPATH**/ ?>