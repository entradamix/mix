      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4">
              <a href="{{ route('scanner.event.ticket', ['language' => $defaultLang->code, 'event_id' => request()->input('event_id'), 'event_type' => request()->input('event_type')]) }}"
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="eventForm" action="{{ route('scanner.ticket_management.update_ticket') }}" method="POST"
