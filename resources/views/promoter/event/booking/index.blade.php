              ...
              <div class="row justify-content-lg-end justify-content-start">
                <div class="col-lg-1">
                  <button class="btn btn-danger btn-sm d-none bulk-delete ml-3 mt-1"
                    data-href="{{ route('promoter.event_booking.bulk_delete') }}">
                    <i class="flaticon-interface-5"></i> {{ __('Delete') }}
                  </button>
                </div>
                <div class="col-lg-3">
                  <form class="ml-3" action="{{ route('promoter.event.booking') }}" method="GET">
                ...
                <div class="col-lg-3">
                  <form id="searchByStatusForm" class="d-flex flex-row align-items-center"
                    action="{{ route('promoter.event.booking') }}" method="GET">
                  ...
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      @foreach ($bookings as $booking)
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="{{ route('promoter.event_booking.details', ['id' => $booking->id]) }}"
                                  class="dropdown-item">
                                  {{ __('Details') }}
                                </a>
                                ...
                                <form class="deleteForm d-block"
                                  action="{{ route('promoter.event_booking.delete', ['id' => $booking->id]) }}"
                                  method="post">
                                  @csrf
                        ...
                        @includeIf('promoter.event.booking.show-attachment')
                      @endforeach
                    </tbody>
                  </table>
                </div>
