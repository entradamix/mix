                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <?php if(!empty($data->breadcrumb)): ?>
                      <img src="<?php echo e(asset('assets/admin/img/' . $data->breadcrumb)); ?>" alt="breadcrumb" class="uploaded-img">
                    <?php else: ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u149868318/domains/vizzion.secretysbet.shop/public_html/resources/views/backend/basic-settings/breadcrumb.blade.php ENDPATH**/ ?>