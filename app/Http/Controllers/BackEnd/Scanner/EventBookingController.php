...
class EventBookingController extends Controller
{
  public function index(Request $request)
  {
    ...
    $organizer_id = Auth::guard('scanner')->user()->organizer_id;
    ...
    $bookings = Booking::join('events', 'events.id', 'bookings.event_id')
      ...
      ->orderByDesc('id')
      ->paginate(10);
    return view('scanner.event.booking.index', compact('bookings'));
  }
  ...
  public function updatePaymentStatus(Request $request, $id)
  {
    ...
    if (Auth::guard('Scanner')->user()->organizer_id != $booking->organizer_id) {
      return back();
    }
  ...
  public function show($id)
  {
    ...
    if (!($booking) || $booking->organizer_id != Auth::guard('scanner')->user()->organizer_id) {
    ...
    return view('scanner.event.booking.details', compact('booking'));
  }
  ...
  public function report(Request $request)
  {
    ...
    if (!empty($fromDate) && !empty($toDate)) {
      $bookings = Booking::join('event_contents', 'event_contents.event_id', 'bookings.event_id')
        ...
        ->where('events.organizer_id', Auth::guard('Scanner')->user()->organizer_id)
    ...
    return view('scanner.event.booking.report', $data);
  }
